...
import { SkinViewer } from "../../../../../components/skin-viewer/ads";
...
export default function Page() {
  ...
  return (
    <SkinViewer
      backTo={`/venatus-test/champions/${key}`}
      linkTo={(skin) => `/venatus-test/champions/${key}/skins/${skin.id}`}
      collectionName={name}
      collectionIcon={<User />}
      collectionPage="/venatus-test/champions/[key]"
      {...{ skin, prev, next }}
    />
  );
}
